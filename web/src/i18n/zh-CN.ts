export default {
  ...
  atx: {
    ...
    wolSend: '发送唤醒包',
    wolSending: '发送中...',
    wolNoTargets: '未配置唤醒目标，请前往设置 - ATX 页面添加',
    wolUnnamedTarget: '未命名',
  },
  setup: {
  ...
  settings: {
    ...
    atxWolEnabled: '启用网络唤醒',
    atxWolEnabledDesc: '开启后远程页面会显示 WOL 控制，可独立于 ATX 电源管理使用',
    atxWolInterface: '网络接口',
    atxWolInterfacePlaceholder: '例如: eth0, enp0s3',
    atxWolTargets: '唤醒目标',
    atxWolTargetsDesc: '最多保存 5 个目标，远程页面直接从这里选择发送对象；留空的行会被忽略',
    atxWolTargetNamePlaceholder: '名称 {index}',
    themeDesc: '选择界面颜色方案',
