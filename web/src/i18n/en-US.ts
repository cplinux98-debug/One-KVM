export default {
  ...
  atx: {
    ...
    wolSend: 'Send Magic Packet',
    wolSending: 'Sending...',
    wolNoTargets: 'No wake targets configured. Add them in Settings - ATX.',
    wolUnnamedTarget: 'Unnamed',
  },
  setup: {
  ...
  settings: {
    ...
    atxWolEnabled: 'Enable Wake-on-LAN',
    atxWolEnabledDesc: 'Shows WOL controls in the console, independently of ATX power management',
    atxWolInterface: 'Network Interface',
    atxWolInterfacePlaceholder: 'e.g. eth0, enp0s3',
    atxWolTargets: 'Wake Targets',
    atxWolTargetsDesc: 'Save up to 5 targets to pick from in the console; blank rows are ignored',
    atxWolTargetNamePlaceholder: 'Name {index}',
